        ...
        <div className="grid grid-cols-2 gap-5 mt-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col">
              <h1 className="text-2xl font-semibold text-orange-900">
                Freelancer Details | ዝርዝር መረጃ
              </h1>
              <div className="flex justify-between mt-2">
                <span>Price Per| Hour ዋጋ በሰዓት</span>
                <span>Birr | ብር {product.price}</span>|
              </div>
              <div className="flex justify-between mt-2">
                <span>Category|ምድብ</span>
              ...
              <div className="flex justify-between mt-2">
                <span>Warranty Available | ዋስትና አለዎት</span>
                <span>{product.warrantyAvailable ? "Yes" : "No"}</span>
              </div>
              <div className="flex justify-between mt-2">
                <span>Experiance | ልምድ</span>
                <span>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-between mt-2">
                <span>Phone |ስልክ</span>
                <span className="uppercase">{product.seller.phone}</span>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <div className="flex justify-between mb-5">
                ...
                >
                  Message and New Bid |መልእክት እና አዲስ ዋጋ
                </Button>
              </div>
                  ...
                  return (
                    <div className="border border-gray-300 border-solid p-3 rounded mt-5">
                      ...
                      <div className="flex justify-between text-gray-600">
                        <span>Bid Amount የቀረበው ዋጋ </span>
                        <span> Birr {bid.bidAmount}</span>
                      </div>
                      <div className="flex justify-between text-gray-600">
                        <span>Bid Place On| የጨረታ ዋጋ የቀረበበት ቀን</span>
                        <span>
                          {" "}
